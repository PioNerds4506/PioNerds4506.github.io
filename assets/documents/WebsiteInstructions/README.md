...
| _includes | There are the partials that can be mixed and matched by the layouts to facilitate reuse.  The liquid tag  can be used to include the partial in *_includes/file.ext*. |
